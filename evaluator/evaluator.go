...
import (
	...
	"github.com/ymdarake/monkey/object"
)
...
// NOTE: evaluates arguments left-to-right
...
func applyFunction(fn object.Object, args []object.Object) object.Object {
	...
	case *object.Function:
		...
		// NOTE: unwrap it so that evalBlockStatement won't stop evaluating statements in 'outer' functions.
...
func evalInfixExpression(operator string, left, right object.Object, env *object.Environment) object.Object {
	...
	// NOTE: for Booleans, we have only TRUE and FALSE objects, which can be compared by its reference.
	case operator == "==":
